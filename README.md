...
* **Autonomous Navigation:** The hunter turtle implements a Proportional (P) Controller to calculate Euclidean distances, dynamically adjust its heading (`theta`), and pursue the closest active target.
...
git clone [https://github.com/YOUR_USERNAME/ros2-turtlesim-catch-turtles.git](https://github.com/YOUR_USERNAME/ros2-turtlesim-catch-turtles.git)

# Build the packages
cd ~/ros2_ws
colcon build --packages-select my_robot_interfaces turtlesim_catch_them_all
